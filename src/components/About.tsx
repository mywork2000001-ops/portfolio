        ...
        <div className="flex items-center gap-5 rounded-2xl bg-white p-6 shadow-sm dark:bg-surface-dark-card">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
              Я разработчик и учитель математики и физики. Совмещаю преподавание в школе с
              созданием образовательных платформ и веб-приложений — от идеи до продакшена. Люблю
              решать сложные задачи и воплощать идеи в реальность.
            </p>
            <a
              href="#about"
